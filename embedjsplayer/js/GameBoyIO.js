...
var settings = [						//Some settings.
	...
	16,									//Interval for the emulator loop (60 fps => 1000ms / 60 => 16.6667ms between each interval to simulate a 60fps framerate).
	10,									//Audio buffer minimum span amount over x interpreter iterations.
	60,									//Audio buffer maximum span amount over x interpreter iterations.
	false,								//Override to allow for MBC1 instead of ROM only (compatibility for broken 3rd-party cartridges).
	false,								//Override MBC RAM disabling and always allow reading and writing to the banks.
	true,								//Use the GameBoy boot ROM instead of the GameBoy Color boot ROM.
	true,								//Scale the canvas in JS, or let the browser scale the canvas?
